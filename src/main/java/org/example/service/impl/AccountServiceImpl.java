...
public class AccountServiceImpl implements AccountService {
    ...
    @Override
    public void increaseTheBalance(Account account, BigDecimal money) {
        account.setMoney(account.getMoney().add(money));
        log.info("Balance account: {}, increase for: {}", account.getId(), money);
    }

    @Override
    public void decreaseTheBalance(Account account, BigDecimal money) throws MoneyLimitException {
